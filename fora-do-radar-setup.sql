...
CREATE TABLE IF NOT EXISTS public.camisolas (
  ...
  nome VARCHAR(255),
  tipo VARCHAR(50), -- 'Home', 'Away', 'Third', 'GK'
  epoca VARCHAR(20), -- '2024', '2023_24', etc
  imagem_url TEXT,
  created_at TIMESTAMP DEFAULT now()
);
...
-- ──────────────────────────────────────────────────────────
-- Próximos passos:
-- 1. Vai a supabase_seed.sql e corre os INSERTs de dados
-- 2. Edita supabase.js com as tuas credenciais (URL e KEY)
